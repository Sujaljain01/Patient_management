...
const CreatePatientProfile = () => {
  ...
  const HandleReportSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('http://localhost:4000/doctors/patientRegistration', ReportValue);
      setLoading(false);
    } catch (error) {
      console.error(error);
      setLoading(false);
    ...
    <>
      ...
      <div className="container w-max">
        ...
        <div className="flex justify-center items-center min-h-screen mx-auto ">
          <div className="w-96 py-12 px-6 lg:px-12 bg-white shadow-lg rounded-lg">
            <h2 className="text-center text-2xl font-semibold mb-6">Create Patient Profile</h2>
            <form onSubmit={HandleReportSubmit}>
              ...
              <div className="mb-4">
                <label className="block text-gray-700 text-sm font-bold mb-2">Patient Age</label>
                <input
                  type="number"
                  placeholder="Age"
                  name="patientAge"
              ...
              <div className="mb-4">
                <label className="block text-gray-700 text-sm font-bold mb-2">Patient Mobile</label>
                <input
                  type="text"
                  placeholder="Mobile"
                  name="patientMobile"
              ...
              <div className="mb-4">
                <label className="block text-gray-700 text-sm font-bold mb-2">Patient Gender</label>
                <select
                  name="patientGender"
                  value={ReportValue.patientGender}
                  onChange={HandleReportChange}
              ...
              <div className="mb-6">
                <label className="block text-gray-700 text-sm font-bold mb-2">Patient Blood Group</label>
                <select
                  name="patientBloodGroup"
                  value={ReportValue.patientBloodGroup}
                  onChange={HandleReportChange}
                  className="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus
focus
"
                  required
                >
              ...
              <button
                ...
                type="submit"
              >
                {loading ? "Generating..." : "Generate Patient Profile"}
              </button>
            </form>
          </div>
        </div>
